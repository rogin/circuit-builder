...
public:
   SDLSEXCEPTION(ERROR error,char additionalInformation[] = "")
   {
      this->error = error;
...
public:
   COMPONENT(char identifier[],TOKEN type,int numberOfINPins)
   {
...
protected:
public:
   GATE(char identifier[],TOKEN type,int numberOfINPins = 1): 
...
{
public:
   ANDGATE(char identifier[],int numberOfINPins): GATE(identifier,AND,numberOfINPins) {}
...
{
public:
   NANDGATE(char identifier[],int numberOfINPins): GATE(identifier,NAND,numberOfINPins) {}
...
{
public:
   ORGATE(char identifier[],int numberOfINPins): GATE(identifier,OR,numberOfINPins) {}
...
{
public:
   NORGATE(char identifier[],int numberOfINPins): GATE(identifier,NOR,numberOfINPins) {}
...
{
public:
   XORGATE(char identifier[],int numberOfINPins): GATE(identifier,XOR,numberOfINPins) {}
...
{
public:
   NOTGATE(char identifier[]): GATE(identifier,NOT) {}
...
private:
   ...
   void FindComponentIdentifier(char identifier[],bool &found,int &index);
   void FindAliasIdentifier(char identifier[],bool &found,NODE &node);
   void AddGate(char identifier[],TOKEN type,int numberOfINPins);
   void AddLatch(char identifier[]);
   void AddBuffer(char identifier[]);
   void AddAlias(char identifier[],NODE node);
...
public:
   CIRCUIT();
   ~CIRCUIT(){};
   void Load(char sourceFilename[]);
   void SetIN(int integer,STATE state);
   void SetIN(char identifier[],STATE state);
   STATE GetIN(int integer);
   STATE GetIN(char identifier[]);
   STATE GetOUT(int integer);
   STATE GetOUT(char identifier[]);
   STATE GetComponentPin(char identifier[],int integer);
   void SimulateLogic();
};
...
//----------------------------------------------------
void CIRCUIT::Load(char sourceFilename[])
//----------------------------------------------------
{
...
//----------------------------------------------------
void CIRCUIT::FindComponentIdentifier(char identifier[],bool &found,int &index)
//----------------------------------------------------
{
...
//----------------------------------------------------
void CIRCUIT::FindAliasIdentifier(char identifier[],bool &found,NODE &node)
//----------------------------------------------------
{
   char uIdentifier1[IDENTIFIERLENGTH+1];
   int i,index;
...
//----------------------------------------------------
void CIRCUIT::AddGate(char identifier[],TOKEN type,int numberOfINPins)
//----------------------------------------------------
{
   numberOfComponents++;
   switch ( type )
...
//----------------------------------------------------
void CIRCUIT::AddLatch(char identifier[])
//----------------------------------------------------
{
   numberOfComponents++;
...
//----------------------------------------------------
void CIRCUIT::AddBuffer(char identifier[])
//----------------------------------------------------
{
   numberOfComponents++;
...
//----------------------------------------------------
void CIRCUIT::AddAlias(char identifier[],NODE node)
//----------------------------------------------------
{
   numberOfAliases++;
...
//----------------------------------------------------
void CIRCUIT::SetIN(char identifier[],STATE state)
//----------------------------------------------------
{
   bool found;
   NODE node;
   ...
   if ( !found || (node.index != INS) )
      ProcessRuntimeError(ILLEGAL_INOUT_ALIAS,identifier);
...
//----------------------------------------------------
STATE CIRCUIT::GetIN(char identifier[])
//----------------------------------------------------
{
   bool found;
   NODE node;
...
//----------------------------------------------------
STATE CIRCUIT::GetOUT(char identifier[])
//----------------------------------------------------
{
   bool found;
   NODE node;
...
//----------------------------------------------------
STATE CIRCUIT::GetComponentPin(char identifier[],int integer)
//----------------------------------------------------
{
   bool found;
   int index;
   ...
   if ( !found )   
      ProcessRuntimeError(UNDEFINED_IDENTIFIER,identifier);
...
//----------------------------------------------------
{
   throw SDLSEXCEPTION(error,additionalInformation);
}

//----------------------------------------------------
char *StateString(STATE state)
//----------------------------------------------------
{
   switch ( state )
   {
