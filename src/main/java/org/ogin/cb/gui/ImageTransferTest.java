...
/*
  pulled from https://www.programcreek.com/java-api-examples/?code=lambdalab-mirror/jdk8u-jdk/jdk8u-jdk-master/test/java/awt/dnd/ImageTransferTest/ImageTransferTest.java
...
public class ImageTransferTest {
    public static void main(String[] arg) throws Exception {
        ...
        ids.frame.setTitle("Drag Source");
        //Util.sync();
...
class ImageDropTarget extends ImageTransferer {
    ...
    public static void main(String[] args) {
        try {
            ...
            idt.frame.setTitle("Drop Target");

            idt.formats = Arrays.copyOf(ids.formats, ids.formats.length);
