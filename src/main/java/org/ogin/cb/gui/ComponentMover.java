...
/**
 *  Generously copied from https://tips4java.wordpress.com/2009/06/14/moving-windows/
 *
...
public class ComponentMover extends MouseAdapter
{
	 ...
	 *  registered using the {@link #registerComponent(Component...)} method.
    ...
    public int getMovementCursor() {
        return movementCursor;
    }

	public void setMovementCursor(int movementCursor) {
	...
	private void setupForDragging(MouseEvent e)
	{
		...
		if (changeCursor)
		{
			...
			source.setCursor( Cursor.getPredefinedCursor(movementCursor) );
		}
